...
public:	
	...
	FORCEINLINE UStaticMeshComponent* GetMeshComponenet() { return MeshComponent; }
	FORCEINLINE void SetMeshComponent(UStaticMeshComponent* Mesh) { MeshComponent = Mesh; }

	FORCEINLINE USphereComponent* GetSphereComponenet() { return SphereComponent; }
	...
	FORCEINLINE USpringArmComponent* GetSpringArmComponenet() { return SpringArm; }
